...
fun SettingItem(icon: ImageVector, title: String) {
    Row(
        ...
        Icon(imageVector = icon, contentDescription = null, tint = PastelRed, modifier = Modifier.size(28.dp))
        Spacer(modifier = Modifier.width(16.dp))
        Text(text = title, fontSize = 18.sp, modifier = Modifier.weight(1f))
        Icon(imageVector = Icons.Default.ArrowForward, contentDescription = null, tint = TextGray)
    }
    HorizontalDivider(color = OutlineGray, thickness = 0.5.dp)
}